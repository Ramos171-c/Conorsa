...
public class DbInitializer : IDbInitializer
{
    ...
    private async Task ResetAndSeedNewCatalogAsync(Guid branchId)
    {
        ...
        var productsData = new List<TempProductData>
        {
            ...
            new("CA034", "TARRO FRESH OLIVE BALL BUBBLEGUM", "Caramelos", "1*12*150", 12, 297.18m, 2377.44m, 187.71m, 1501.71m, 223.98m, 1791.82m, 116.67m, 1400.00m),
            new("CA035", "TARRO RUGBY BALL BUBBLE GUM", "Caramelos", "1*24*220", 24, 297.36m, 2378.88m, 90.00m, 720.00m, 214.77m, 1718.18m, 33.33m, 800.00m),
            new("CA036", "TARRO SUPER TARZAN BUBBLE GUM", "Caramelos", "1*12*250", 12, 297.54m, 2380.32m, 102.86m, 822.86m, 122.73m, 981.82m, 95.83m, 1150.00m),
            new("CA037", "KOBA TARRO FRESH OLIVE BALL BUBBLEGUM", "Caramelos", "1*24*100", 24, 297.72m, 2381.76m, 73.93m, 591.43m, 176.42m, 1411.36m, 31.25m, 750.00m),
            new("CA038", "CARAMELO CRYSTAL", "Caramelos", "1*8*200", 8, 297.90m, 2383.20m, 144.64m, 1157.14m, 115.06m, 920.45m, 150.00m, 1200.00m),
            new("CA039", "BOLSA JUICE BURST", "Caramelos", "1*12*150", 12, 298.08m, 2384.64m, 154.29m, 1234.29m, 184.09m, 1472.73m, 133.33m, 1600.00m),
            new("CA040", "YOHAN BALL BUBBLEGUM", "Caramelos", "1*12*250", 12, 298.26m, 2386.08m, 205.71m, 1645.71m, 245.45m, 1963.64m, 110.00m, 1320.00m),
