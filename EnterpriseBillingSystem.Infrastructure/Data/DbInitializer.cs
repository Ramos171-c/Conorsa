...
public class DbInitializer : IDbInitializer
{
    ...
    public async Task InitializeAsync()
    {
        ...
        foreach (var role in dbRoles)
        {
            IEnumerable<Permission> rolePerms = role.Name switch
            {
                ...
                "VENDEDOR" => allPermissions.Where(p => p.Code == "products.view" || p.Code == "categories.view" || p.Code == "customers.view" || p.Code == "customers.create" || p.Code == "customers.edit" || p.Code == "cash.view" || (p.Code.StartsWith("sales.") && p.Code != "sales.cancel") || p.Code == "ar.view"),
                "CAJERO" => allPermissions.Where(p => p.Code == "categories.view" || p.Code == "customers.view" || p.Code == "customers.create" || p.Code == "customers.edit" || p.Code.StartsWith("sales.") || (p.Code.StartsWith("cash.") && p.Code != "cash.manage") || p.Code == "ar.view" || p.Code == "ar.payment" || p.Code == "ap.view" || p.Code == "ap.payment"),
    ...
    private async Task ResetAndSeedNewCatalogAsync(Guid branchId)
    {
        ...
        var productsData = new List<TempProductData>
        {
            ...
            new("CA002", "DISPENSADOR CANDY SUPLAY CANDY BRUSH", "Caramelos", 12, 180.00m, 2160.00m, 192.86m, 2314.29m, 153.41m, 1840.91m),
            new("CA003", "DISPENSADOR YUGL GOMITA GUITARRA", "Caramelos", 12, 207.60m, 2491.20m, 222.43m, 2669.14m, 176.93m, 2123.18m),
            new("CA004", "DISPENSADOR BON TON ROLL", "Caramelos", 24, 120.00m, 2880.00m, 128.57m, 3085.71m, 102.27m, 2454.55m),
            new("CA005", "BOLSA DE BON TON", "Caramelos", 12, 252.00m, 3024.00m, 270.00m, 3240.00m, 214.77m, 2577.27m),
            new("CA006", "BOLSA TEDDY BEAR 4", "Caramelos", 12, 120.00m, 1440.00m, 128.57m, 1542.86m, 102.27m, 1227.27m),
            new("CA007", "TARROS NR 112 MIX TERMO CARAMELO", "Caramelos", 6, 528.00m, 3168.00m, 660.00m, 3960.00m, 450.00m, 2700.00m),
            new("CA008", "DISPENSADOR SORPRESA DEL MUNDIAL 3D", "Caramelos", 20, 151.20m, 3024.00m, 162.00m, 3240.00m, 128.86m, 2577.27m),
            new("CA009", "HERMETICO MD 198C KING EGG CHOCOLATE HERMETICO", "Caramelos", 6, 528.00m, 3168.00m, 565.71m, 3394.29m, 450.00m, 2700.00m),
            new("CA010", "CANDY MINI GELATINA BOLSA GRANDE 1.5 KG.", "Caramelos", 8, 126.00m, 1008.00m, 135.00m, 1080.00m, 107.39m, 859.09m),
            new("CA011", "BOLSA CANDY MINI GELATINA LAS DELICIA PEQUEÑA", "Caramelos", 40, 25.20m, 1008.00m, 27.00m, 1080.00m, 21.48m, 859.09m),
            new("CA012", "DISPENSADOR CANDY SUPLAY CHUPON LUZ", "Caramelos", 12, 156.00m, 1872.00m, 167.14m, 2005.71m, 132.95m, 1595.45m),
            new("CA013", "DISPENSADOR CANDY SUPLAY PALETA LUZ ANILLO", "Caramelos", 12, 156.00m, 1872.00m, 167.14m, 2005.71m, 132.95m, 1595.45m),
            new("CA014", "DISPENSADOR CANDY CHOCO CRUCH CONO", "Caramelos", 12, 144.00m, 1728.00m, 154.29m, 1851.43m, 122.73m, 1472.73m),
            new("CA015", "DISPENSADOR MD 233 KING EGG HUEVO EN CHOCOLATE", "Caramelos", 12, 240.00m, 2880.00m, 257.14m, 3085.71m, 204.55m, 2454.55m),
            new("CA016", "TARRO CANDY SUPLAY MINI CHICLE TATOO", "Caramelos", 24, 132.00m, 3168.00m, 141.43m, 3394.29m, 112.50m, 2700.00m),
            new("CA017", "BOLSA CANDY SUPLAY MINI CHICLE TATOO", "Caramelos", 24, 120.00m, 2880.00m, 128.57m, 3085.71m, 102.27m, 2454.55m),
            new("CA018", "DISPENSADOR MD RF 2155-3 SLAY STITCH", "Caramelos", 16, 708.00m, 11328.00m, 758.57m, 12137.14m, 603.41m, 9654.55m),
            new("CA019", "TARRO MD MINI KRIZZY HUEVO CELESTE", "Caramelos", 12, 300.00m, 3600.00m, 321.43m, 3857.14m, 255.68m, 3068.18m),
            new("CA020", "TARRO MD MINI KRIZZY HUEVO ROJO", "Caramelos", 12, 300.00m, 3600.00m, 321.43m, 3857.14m, 255.68m, 3068.18m),
            new("CA021", "DISPENSADOR PECCIN CHICLE BLONG NAPOLITANO", "Caramelos", 24, 72.00m, 1728.00m, 77.14m, 1851.43m, 61.36m, 1472.73m),
            new("CA022", "BOLSA MD NR 47 CARAMELO MIX 3 LIBRAS", "Caramelos", 6, 235.20m, 1411.20m, 252.00m, 1512.00m, 200.45m, 1202.73m),
            new("CA023", "BOLSA MD NR 47 CARAMELO MIX 5 LIBRAS", "Caramelos", 6, 384.00m, 2304.00m, 411.43m, 2468.57m, 327.27m, 1963.64m),
            new("CA024", "BOLSA MD NR 47 CARAMELO MIX 10 LIBRAS", "Caramelos", 4, 720.00m, 2880.00m, 771.43m, 3085.71m, 613.64m, 2454.55m),
            new("CA025", "DISPENSADOR MD CRISPY TWINS DOBLE ROLLO CHOCOLATE CAJA ANARANJADA", "Caramelos", 20, 144.00m, 2880.00m, 154.29m, 3085.71m, 122.73m, 2454.55m),
            new("CA026", "DISPENSADOR MD CRISPY TWINS DOBLE ROLLO FRESA CAJA ROSADA", "Caramelos", 20, 144.00m, 2880.00m, 154.29m, 3085.71m, 122.73m, 2454.55m),
            new("CA027", "DISPENSADOR MD CRISPY TWINS DOBLE ROLLO LECHE CAJA AZUL", "Caramelos", 20, 144.00m, 2880.00m, 154.29m, 3085.71m, 122.73m, 2454.55m),
            new("CA028", "UNIDADES CANDY MINI BOLO SURTIDO NIÑA", "Caramelos", 100, 47.52m, 4752.00m, 50.91m, 5091.43m, 40.50m, 4050.00m),
            new("CA029", "UNIDADES CANDY MINI BOLO SURTIDO NIÑO", "Caramelos", 100, 47.52m, 4752.00m, 50.91m, 5091.43m, 40.50m, 4050.00m),
            new("CA030", "UNIDADES MD NR 168 CHOCOLATE MILKSTAR PANA", "Caramelos", 6, 372.00m, 2232.00m, 398.57m, 2391.43m, 317.05m, 1902.27m),
            new("CA031", "UNIDADES MD NR 168 CHOCOLATE MIL STAR PANA", "Caramelos", 6, 372.00m, 2232.00m, 398.57m, 2391.43m, 317.05m, 1902.27m),
            new("CA032", "MD 423 SOUR CANDY SUPER STIMULANTE EXTREMO ACIDO", "Caramelos", 20, 148.32m, 2966.40m, 158.91m, 3178.29m, 126.41m, 2528.18m),
            new("CA033", "TARRO MD NTC-321 OJO EN TARRO CON TRONADOR", "Caramelos", 8, 297.00m, 2376.00m, 318.21m, 2545.71m, 253.13m, 2025.00m),

            // Malvaviscos (8)
            new("MA001", "BOLSA CANDY SUPLAY MALVAVISCO SUPER MINI MINO", "Malvaviscos", 8, 252.00m, 2016.00m, 270.00m, 2160.00m, 214.77m, 1718.18m),
            new("MA002", "BOLSA MALVAVISCO MALVA MUFFIN", "Malvaviscos", 12, 132.00m, 1584.00m, 141.43m, 1697.14m, 112.50m, 1350.00m),
            new("MA003", "BOLSA MALVAVISCO ICE CREAM PLUS", "Malvaviscos", 12, 144.00m, 1728.00m, 154.29m, 1851.43m, 122.73m, 1472.73m),
            new("MA004", "BOLSA MALVAVISCO ICE CREAM ACIDULADO", "Malvaviscos", 12, 144.00m, 1728.00m, 154.29m, 1851.43m, 122.73m, 1472.73m),
            new("MA005", "BOLSA MALVAVISCO YETI MALLOW", "Malvaviscos", 12, 162.00m, 1944.00m, 173.57m, 2082.86m, 138.07m, 1656.82m),
            new("MA006", "BOLSA MALVAVISCO RELLENO TRI PACK", "Malvaviscos", 15, 117.12m, 1756.80m, 125.49m, 1882.29m, 99.82m, 1497.27m),
