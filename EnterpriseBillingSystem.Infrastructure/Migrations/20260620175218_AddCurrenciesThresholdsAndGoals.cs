...
{
    /// <inheritdoc />
    public partial class AddCurrenciesThresholdsAndGoals : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PricingThresholds", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingThresholds_LevelName",
                table: "PricingThresholds",
                column: "LevelName",
                unique: true,
                filter: "[IsDeleted] = 0");
