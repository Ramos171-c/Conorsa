        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerIdentificationSnapshot = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesInvoices_BranchWarehouses_BranchWarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SalesOrderDetail_DiscountPct", "[DiscountPercentage] >= 0 AND [DiscountPercentage] <= 100");
                    table.CheckConstraint("CK_SalesOrderDetail_Quantity", "[Quantity] > 0");
                    table.CheckConstraint("CK_SalesOrderDetail_UnitPrice", "[UnitPrice] >= 0");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrderDetails_UnitsOfMeasure_UnitOfMeasureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SalesInvoiceDetail_DiscountPct", "[DiscountPercentage] >= 0 AND [DiscountPercentage] <= 100");
                    table.CheckConstraint("CK_SalesInvoiceDetail_Quantity", "[Quantity] > 0");
                    table.CheckConstraint("CK_SalesInvoiceDetail_UnitPrice", "[UnitPrice] >= 0");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesInvoiceDetails_UnitsOfMeasure_UnitOfMeasureId",
                        column: x => x.UnitOfMeasureId,
                        principalTable: "UnitsOfMeasure",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoiceDetails_UnitOfMeasureId",
                table: "SalesInvoiceDetails",
                column: "UnitOfMeasureId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoices_BranchWarehouseId",
                table: "SalesInvoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderDetails_UnitOfMeasureId",
                table: "SalesOrderDetails",
                column: "UnitOfMeasureId");
