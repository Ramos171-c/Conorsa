        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_JournalEntryDetails_Amounts", "([DebitAmount] >= 0 AND [CreditAmount] >= 0) AND (([DebitAmount] > 0 AND [CreditAmount] = 0) OR ([DebitAmount] = 0 AND [CreditAmount] > 0))");
                    table.ForeignKey(
