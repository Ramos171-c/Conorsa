...
with open("get_presentations_all.ps1", "w", encoding="utf-8") as f:
    f.write(ps_code)

res = subprocess.run(["powershell", "-ExecutionPolicy", "Bypass", "-File", "get_presentations_all.ps1"], capture_output=True, text=True)
print(res.stdout)
