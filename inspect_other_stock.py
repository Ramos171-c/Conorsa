...
with open("check_other_stock.ps1", "w", encoding="utf-8") as f:
    f.write(ps_code)

res = subprocess.run(["powershell", "-ExecutionPolicy", "Bypass", "-File", "check_other_stock.ps1"], capture_output=True, text=True)
print(res.stdout)
