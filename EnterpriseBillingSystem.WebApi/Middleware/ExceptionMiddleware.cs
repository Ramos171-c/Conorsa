...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var problemDetails = new ProblemDetails
        {
            ...
            Detail = _env.IsDevelopment() || exception is ValidationException || exception is InvalidOperationException || exception is ArgumentException ? exception.Message : "Ha ocurrido un error interno al procesar su solicitud.",
